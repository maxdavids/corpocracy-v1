 ...
 */
class UIShaderPlane extends Shader
{
  constructor(renderer:Renderer)
  {
     ...
     uniform vec2 uVSize;
		 ...
		 void main(void) {
		   ...
		   vec2 sPosCorner = vNDCAtts.zw * uVSize - 0.5 / uVSize;
			 ...
			 vec4 result = mix(color, uFillColor, uFillColor.a);
    ...
    this.init("ui_shader_plane",vProgram, fProgram);
  }
}
export default UIShaderPlane;
