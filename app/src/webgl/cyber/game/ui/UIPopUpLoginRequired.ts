 ...
 */
class UIPopUpLoginRequired implements IUIScreen{
  ...
  protected _uiData:any = {
    ...
    label_one_line:{ x:-1, y:1, pxOffX:20, pxOffY:-65, pxHeight:10 },
  ...
  protected build():void
  {
    ...
    (this._frame.getMaterial() as UIMaterialPlane).fillColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR0);
    (this._frame.getMaterial() as UIMaterialPlane).borderColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR1);
    ...
    (this._square.getMaterial() as UIMaterialPlane).fillColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR2);
    (this._square.getMaterial() as UIMaterialPlane).borderColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR2);
    ...
    this._label = new TextRenderable(this._renderer, titleText, [UIGlobals.CORP1_COLOR2], TextPivot.LEFT, TextPivot.CENTER, 0.7);
    this._label.getMaterial().setTexture(this._assetsLoader.getAsset("tex_glyphs") as Texture2DLoader);
    this._label.getMaterial().backColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR0);
    this._renderables.push(this._label);

    const mainText:string[] = [
      "$PLEASE LOGIN TO YOUR METAMASK ACCOUNT"
    ];
    this._labelOneLine = new TextRenderable(this._renderer, mainText, [UIGlobals.CORP1_COLOR2], TextPivot.LEFT, TextPivot.TOP, 0.7);
    this._labelOneLine.getMaterial().setTexture(this._assetsLoader.getAsset("tex_glyphs") as Texture2DLoader);
    this._labelOneLine.getMaterial().backColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR0);
    ...
    (this._line1.getMaterial() as UIMaterialPlane).fillColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR1);
    (this._line1.getMaterial() as UIMaterialPlane).borderColor = Utils.hexToRGBA(UIGlobals.CORP1_COLOR1);
...
export default UIPopUpLoginRequired;
